...
-   01: [Feature engineering using recipes](slides/advanced-01-feature-engineering.html)
...
-   [Transit Case Study (includes stacking)](slides/extras-transit-case-study.qmd)
-   [Effect encodings]()
