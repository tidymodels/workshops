...
These are the materials for workshops on [tidymodels](https://www.tidymodels.org/) offered at [LatinR 2023](https://latin-r.com/en/). The tidymodels framework is a collection of packages for modeling and machine learning using [tidyverse](https://www.tidyverse.org/) principles. This website hosts the materials for both the _Introduction to tidymodels_ and _Advanced tidymodels_ courses.
...
**For the advanced slides**, you should install the newest version of the dials package (version 1.3.0). To check this, you can run: 
