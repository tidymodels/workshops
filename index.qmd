...
These are the materials for workshops on [tidymodels](https://www.tidymodels.org/) offered at the [2025 New York Data Science & AI Conference](https://rstats.ai/nyc). The tidymodels framework is a collection of packages for modeling and machine learning using [tidyverse](https://www.tidyverse.org/) principles. This website hosts the materials for both the _Introduction to Machine Learning in R with tidymodels_ and _Advanced tidymodels_ courses.
...
Depending on your background, one of _Introduction to Machine Learning in R with tidymodels_ or _Advanced tidymodels_ might serve you better than the other.
...
# We'll install this one from GitHub prior to its next CRAN release (around Sept 2025)
