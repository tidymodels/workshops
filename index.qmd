...
-   01: [Feature engineering using recipes](slides/advanced-02-feature-engineering.html){target="_blank"}
-   02: [Tuning hyperparameters (grid search)](slides/advanced-03-tuning-hyperparameters.html){target="_blank"}
-   03: [Grid search via racing](slides/advanced-04-racing.html){target="_blank"}
-   04: [Iterative search](slides/advanced-05-iterative.html){target="_blank"}
