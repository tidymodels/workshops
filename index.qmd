...
These are the materials for workshops on [tidymodels](https://www.tidymodels.org/) offered at the [2025 New York Data Science & AI Conference](https://rstats.ai/nyc). The tidymodels framework is a collection of packages for modeling and machine learning using [tidyverse](https://www.tidyverse.org/) principles. This website hosts the materials for both the _Introduction to tidymodels_ and _Advanced tidymodels_ courses.
