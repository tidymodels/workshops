---
title: "6 - Feature engineering: splines, target encoding and dates"
...
```{r}
#| label: fig-arrival-date-num-vs-avg-price-per-room
#| echo: false
hotel_train |>
...
```{r}
#| label: fig-spline-knots-1-degree-1
#| echo: false
workflow(
...
```{r}
#| label: fig-spline-knots-2-degree-1
#| echo: false
workflow(
  recipe(avg_price_per_room ~ arrival_date_num, data = hotel_train) |> 
...
```{r}
#| label: fig-spline-knots-5-degree-1
#| echo: false
workflow(
  recipe(avg_price_per_room ~ arrival_date_num, data = hotel_train) |> 
...
```{r}
#| label: fig-spline-knots-5-degree-2
#| echo: false
workflow(
  recipe(avg_price_per_room ~ arrival_date_num, data = hotel_train) |> 
...
```{r}
#| label: fig-spline-knots-5-degree-3
#| echo: false
workflow(
  recipe(avg_price_per_room ~ arrival_date_num, data = hotel_train) |> 
...
```{r}
#| label: fig-spline-knots-9-degree-3
#| echo: false
workflow(
  recipe(avg_price_per_room ~ arrival_date_num, data = hotel_train) |> 
...
```{r}
#| label: fig-step-date-before-inverse
#| echo: false
rules <- list(rule_1 = rule_1, rule_2 = rule_2, rule_3 = rule_3)
...
```{r}
#| label: fig-step-date-after-inverse
#| echo: false
rules <- list(rule_1 = rule_1, rule_2 = rule_2, rule_3 = rule_3)
...
```{r}
#| label: fig-step-date-nearest-inverse
#| echo: false
rules <- list(rule_1 = rule_1, rule_2 = rule_2, rule_3 = rule_3)
