...
More information on initial data splitting can be found in: 

 - _Tidy Models with R_: [Spending our Data](https://www.tmwr.org/splitting)
 - _Applied Machine Learning for Tabular Data_: [Initial Data Splitting](https://aml4td.org/chapters/initial-data-splitting.html)
...
More information on validation sets can be found in: 

 - _Tidy Models with R_: 
   - [What About a Validation Set?](https://www.tmwr.org/splitting#what-about-a-validation-set)
   - [A Picture is Worth a Thousand... Beans](https://www.tmwr.org/dimensionality#beans) (data analysis example)
...
The description below is a condensed (and less mathy) version of the section in _Applied Machine Learning for Tabular Data_ called [Effect Encodings](https://aml4td.org/chapters/categorical-predictors.html#sec-effect-encodings).
