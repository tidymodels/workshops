...
What's the story with `!!stations`? 

`stations` is a vector of 20 column names we want to use in the steps. If the list were shorter, we could type them in (e.g., `c("col1", "col2")` etc.). 
