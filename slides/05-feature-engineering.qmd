...
We _could_ try to optimize the threshold for collapsing (see the next section of notes).
...
nhl_glm_set_res <-
  workflow_set(
    list(`1_other` = nhl_other_rec, 2_effects` = nhl_effect_rec, 
         `3_angle` = nhl_angle_rec, `4_bgl` = nhl_behind_rec),
