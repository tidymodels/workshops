...
Where do centering and scaling belong in the diagram? 

## Two types of preprocessing

![](images/fe_venn_info.svg){.absolute bottom="0" right="0" height="400"}

Where does re-encoding a date belong in the diagram? 
...
-   From Pittsburgh Penguins games, `r format(nrow(ongoal::season_2015), big.mark = ",")` shots on goal
