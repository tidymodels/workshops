...
```{r}
#| echo: false
countdown(minutes = 10, id = "nhl-explore")
```
:::
:::
...
-   *any additional step needed for your chosen model from Day 1*
...
*Use `fit_resamples()` to fit your workflow from Day 1 with a recipe.*

*Save the predictions from the results.* 

*Collect the metrics and compare your model to `nhl_glm_wflow`.*
...
```{r}
#| echo: false
countdown(minutes = 3, id = "roc-curve-data")
```
