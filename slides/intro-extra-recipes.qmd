...
This data set originally contained a datetime variable. If given as a raw predictor, it is converted to an integer.
...
*What other transformations could be do with the raw time variable?*
