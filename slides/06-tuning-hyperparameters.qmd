...
Most modern boosting methods have *a lot* of tuning parameters. \* For tree growth and pruning (`min_n`, `max_depth`. etc). \* For boosting (`trees`, `stop_iter`, `learn_rate`)
