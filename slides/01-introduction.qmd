...
pkgs_core <-
  c("almanac", "dimRed", "embed", "extrasteps", "future", "igraph",
    "irlba", "lme4", "mirai", "parallelly", "probably", "RANN",
    "ranger", "RcppML", "rpart", "rpart.plot", "RSpectra", "splines2",
    "tidymodels", "xgboost")

pkgs_extras <-
  c("bonsai", "brulee", "Cubist", "desirability2", "earth", "finetune",
    "important", "kknn", "lightgbm", "rules", "stacks")
