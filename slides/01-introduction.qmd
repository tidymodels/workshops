...
plot_roc <- function(x, highlight = "1_dummy_logistic") {
...
lvls <- c("1_dummy_logistic", "encoded_logistic", "2_angle_logistic", "3_dist_logistic", 
...
plot_roc(roc_curves, "1_dummy_logistic") + theme_bw()
```
