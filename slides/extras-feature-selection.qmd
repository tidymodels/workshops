---
title: "Extras - Feature selection"
...
#| code-line-numbers: "|3-4|5-6|8-10|12-13|"
set.seed(429)
class_data <- 
...
#| include: false
noise_ind <- 17:31
noise_cols <- names(class_data)[noise_ind]
num_noise <- length(noise_ind)
num_total <- ncol(sim_train) - 1
```
...
# Imbalanced example {background-color="#EDD6D5FF"}
