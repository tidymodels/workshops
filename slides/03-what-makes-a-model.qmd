...
## To specify a model with parsnip `r hexes("parsnip")` {background-color="#f7dde0"}
...
## Deploy your model `r hexes("parsnip", "workflows", "vetiver")`
...
## Predict with your model `r hexes("parsnip", "workflows", "vetiver")`
