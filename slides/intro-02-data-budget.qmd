...
There are `r nrow(example_test)` rows and `r ncol(example_test)` columns in the test set.
...
set.seed(123)
example_split <- initial_split(class_data, prop = 0.8)
example_train <- training(example_split)
example_test <- testing(example_split)
...
*Explore the `example_train` data on your own!*
