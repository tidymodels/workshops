...
Creating a split in the data requires some random number generation to determine which observations go in which set

This random number generation is deterministic in R, and we can **seed** it to get the same results over and over again

The seed you pick doesn't matter, as long as you don't try a bunch of seeds and pick the one that gives you the best performance
...
:::notes
We will use this in Advanced tidymodels
:::
