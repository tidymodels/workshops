...
Calibration is a property of individual predictions.

- A well-calibrated probability occurs _in the wild_ at the same rate as the estimate. 
...
We won't be discussing iterative search methods today. but you can learn more in [AML4TD](https://aml4td.org/chapters/iterative-search.html).
...
In th enext slide deck (on racing), there are more examples of speed-ups for a different model. 
...
::: notes
The curve hugging the bottom of the plot means that we are drastically _overestimating_ the probability of class "event" relative to how often it occurs "in the wild."
