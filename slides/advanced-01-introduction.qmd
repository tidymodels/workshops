...
Location:  [https://github.com/tidymodels/workshops](https://github.com/tidymodels/workshops)

<br>

Options for GitHub users: 
...
If you do not have a GitHub account: 
  ...
  - Click on [<> Code]{style="background-color:#1f883d; color:white; padding:0.2em 0.4em; border-radius:6px; font-family:monospace;"} then `Download ZIP`.
