...
We evaluated 250 models (25 candidates times 10 resamples).
...
_However_... there is typically a large resample effects in the results. 
...
With $n = 10$ resamples, the confidence interval for the difference in the model error is (`r signif(race_ci$lower[9], 2)`, `r signif(race_ci$upper[9], 2)`), indicating that candidate number 2 has smaller error. 
...
```{r}
#| label: boost-spec
#| code-line-numbers: "|3-7|10-12|14-15|"
...
#| label: lgb-grid-race
#| cache: true
#| code-line-numbers: "|1-2|4-5|10|12-13|"
