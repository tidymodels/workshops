...
There are a lot of examples in [_Feature Engineering and Selection_](https://bookdown.org/max/FES/) (FES), [_Applied Machine Learning for Tabular Data_](https://aml4td.org/) (aml4td), and [_Feature Engineering A-Z_](https://feaz-book.com/)
...
-   *use a [Yeo-Johnson (YJ) transformation](https://aml4td.org/chapters/numeric-predictors.html#sec-skewness) on `lead_time`*
