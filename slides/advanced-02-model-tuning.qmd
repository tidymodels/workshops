...
## Did it work?   `r hexes(c("broom", "yardstick", "rsample", "brulee"))` 
...
## Extract and update parameters `r hexes(c("dials", "workflows"))`  {.annotation}
...
## Neural network tuning `r hexes(c("dials", "workflows", "tune"))`   {.annotation}
