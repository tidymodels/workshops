...
pkgs <- 
  c("bonsai", "C5.0", "Cubist", "doParallel", "earth", "embed", "finetune", 
    "forested", "lightgbm", "lme4", "pak", "parallelly", "plumber", "probably", 
...
Also, you should make sure that you have installed the newest version of the tidymodels package (version 1.4.1). To check this, you can run: 
