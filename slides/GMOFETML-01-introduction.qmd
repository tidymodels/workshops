...
pkgs <- c("almanac", "betacal", "bonsai", "C5.0", "Cubist", "dimRed", 
          "doParallel", "earth", "embed", "extrasteps", "finetune", "forested", 
          "igraph", "irlba", "kknn", "lightgbm", "lme4", "mirai", "parallelly", 
          "plumber", "probably", "ranger", "RANN", "rpart", "rpart.plot", 
          "RSpectra", "rules", "splines2", "stacks", "text2vec", "textrecipes", 
          "tidymodels", "uwot", "vetiver")
...
We're here to learn more about how to use the more advanced bits of tidymodels for supervised learning. 

<br>

. . .

First, let's load the meta-package: 
...
Second: you might want to run this function to avoid function name conflicts: 
...
::: incremental
 - `class_data`: a simulated set of data with a 1:10 class imbalance. Two classes, 20 predictors, and 2,000 samples. 
...
These data can be loaded from the GutHub repo: 
...
## Recipes and workflows `r hexes(c("recipes", "workflow"))`
...
pkgs <- c("almanac", "betacal", "bonsai", "C50", "Cubist", "dimRed", 
          "doParallel", "earth", "embed", "extrasteps", "finetune", "forested", 
          "igraph", "irlba", "kknn", "lightgbm", "lme4", "mirai", "parallelly", 
          "plumber", "probably", "ranger", "RANN", "rpart", "rpart.plot", 
          "RSpectra", "rules", "splines2", "stacks", "text2vec", "textrecipes", 
