...
- Number of hashing features to retain
...
We just tuned the model over the number of trees in the ensemble. 

What if we set a specific number of trees and tuned the "early stopping" parameters? 

 - How many iterations of worst performance before we stop adding new trees? 

This is an alternate approach to tuning these models. 

We could set `trees = 1000` and tune the `stop_iter` parameter. 
