...
- Gráficar los falsos positivos en el axis X, contra los verdaderos positivos
en el axis Y.

Ya que la sensibilidad es la proporción de verdaderos positivos, y la especificidad 
es la de los verdaderos negativos, entonces `1 - especificidad` es la
...
TODO: restore r
- `taxi_entrenaring_roc_auc` for the training set
- `taxi_pruebaing_roc_auc` for test set
:::
:::
