...
-   Los **datos de prueba ** se ponen aparte para medir la eficacia del modelo
...
buena manera de medir la **eficacia** del modelo
...
# Sus datos de prueba son preciosos 💎
...
*Explore the `taxi_entrenar` data on your own!*
